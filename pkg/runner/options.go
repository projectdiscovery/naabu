...
type Options struct {
	...
	OutputFilter     goflags.StringSlice // OutputFilter is the filter to apply to the output
...
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("output", "Output",
		...
		flagSet.StringSliceVarP(&options.OutputFilter, "output-filter", "of", nil, "filter output based on a condition", goflags.NormalizedOriginalStringSliceOptions),
