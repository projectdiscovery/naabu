...
const (
	...
	// ICMP host discovery O(n) slow for large CIDRs (issue #1672); 8 is
	// a conservative default that keeps memory + descriptor pressure low
	// while letting the kernel overlap most retry waits.
	icmpWriteWorkers = 8
)
